...
<div class="flex h-screen w-full items-center justify-center bg-gray-900  " style="background-image: url('<?= ROOT_DIR ?>assets/images/dimension.png')">
  <div class="rounded-xl bg-red-800 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
    <div class="text-white">
      <div class="mb-8 flex flex-col items-center">
        <img src="<?= ROOT_DIR ?>assets\images\Theater_Masks.png" width="150" alt="" srcset="" />
        <h1 class="mb-2 text-2xl font-serif	font-family: Georgia, Cambria,">King's Theatre</h1>
