    ...
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
        ...
        <div class="relative flex items-end overflow-hidden rounded-xl">
          ...
          <div class="flex items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600">
            ...
            <button href="<?= ROOT_DIR ?>blog/details.php" class="text-sm">READ MORE..</button>
          </div>
        </div>

        <div class="mt-1 p-2">
          <h2 class="text-slate-700">ARTICLE ONE</h2>
          <p class="mt-1 text-sm text-slate-400">For this layout I would add a few lines of the article 
            to give the reader a quick look.
          </p>
          ...
          <div class="mt-3 flex items-end justify-between">
            ...
            <button onclick="window.location.href='details.php';" class="text-sm">READ MORE...</button>
